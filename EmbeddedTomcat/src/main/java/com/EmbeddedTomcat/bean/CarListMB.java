package com.EmbeddedTomcat.bean;

import com.EmbeddedTomcat.infra.model.Filter;
import com.EmbeddedTomcat.model.Car;
import com.EmbeddedTomcat.service.CarService;
...
import static com.EmbeddedTomcat.util.Utils.addDetailMessage;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                com.EmbeddedTomcat.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? com.EmbeddedTomcat.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? com.EmbeddedTomcat.infra.model.SortOrder.DESCENDING
                            : com.EmbeddedTomcat.infra.model.SortOrder.UNSORTED;
                }
